	...
	<body>
		<div class="site-content">
				...
				<div class="container">
					...
					<div class="main-navigation">
						...
						<ul class="menu">
							...
							<#if user??>
							<li class="menu-item current-menu-item"><a href="/users">User<small>see admin users</small></a></li>
			...
			<div class="page-head" data-bg-image="static/images/page-head-1.jpg">
				<div class="container">
					<h2 class="page-title"><a href="/create">Users</a></h2>
				</div>
			</div>
						...
						<div class="row">
							<div class="content col-md-8">
								...
								<#if users?? && (users?size > 0)>
								    <#list users as users>
									<div class="family">
										<img src="static/images/family-1.jpg" alt="" class="family-image">
										<h3 class="family-name">Name: ${users.userId}</h3>
										<h3 class="family-name">Phone No.: ${users.phone}</h3>
										<h3 class="family-name">Password: ${users.password}</h3>
									</div>
									</#list>
								</#if>
								</div>
